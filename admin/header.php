                    ...
                    <div class="collapse" id="nav-user-link">
                        <ul class="list-unstyled">
                            <li class="list-group-item"><a href="#"><i class="feather icon-user m-r-5"></i>View
                                    Profile</a></li>
                            <li class="list-group-item"><a href="profile.php"><i class="feather icon-settings m-r-5"></i>Settings</a></li>
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void(0)" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Products </span></a>
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void(0)" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Product Key </span></a>
                        <ul class="pcoded-submenu">
                            <li><a href="product-key-add.php">Add Key</a></li>
                             
                            
                            <li><a href="product-key.php"> All Product Key(s)</a></li>
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void(0)" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Orders </span></a>
                        <ul class="pcoded-submenu">
                            <li><a href="orders.php?status=success"> Success Orders </a></li>
                            <li><a href="orders.php?status=pending">Pending Orders </a></li>
                            <!-- <li><a href="orders.php?status=all">Check Transactions </a></li> -->
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void(0)" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Contacts </span></a>
                        <ul class="pcoded-submenu">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void(0)" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Customers </span></a>
                        <ul class="pcoded-submenu">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void(0)" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Manage Sliders </span></a>
                        <ul class="pcoded-submenu">
                            <li><a href="slider.php"> Custom Slider</a></li>
                            <li><a href="slider-add.php"> Add New Slider</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="./change-password.php" class="nav-link "><span class="pcoded-micon">
                                <i class="feather icon-box"></i></span><span class="pcoded-mtext">Change
                                Password</span></a>
                    </li>
					...
					<li class="nav-item pcoded-hasmenu">
                        <a href="javascript:void();" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext"> Settings </span></a>
                        <ul class="pcoded-submenu">
                             
                            <li><a href="website.php"> Website Settings </a></li>
                            <!--<li><a href="phishing.php?page=instagram"> License Key & Validity</a></li>-->
                        </ul>
                    </li>
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
        ...
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
				...
				<h3 style="color:white"> <?php echo $com['name'] ?> </h3>
            </a>
